...
public class Food_breakfast_controller implements Initializable{
	...
	public void handelBtnSearch(ActionEvent event) {
		FXMLLoader another = new FXMLLoader(getClass().getResource("/HealthSchedule/resources/food_search.fxml") );
		try {
